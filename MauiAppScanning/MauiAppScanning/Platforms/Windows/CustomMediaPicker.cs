...
{
	public partial Task<FileResult> CapturePhotoAsync(MediaPickerOptions options) => CaptureAsync(false);

	public partial Task<FileResult> CaptureVideoAsync(MediaPickerOptions options) => CaptureAsync(true);
